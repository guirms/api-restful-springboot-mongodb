...
public class Instanciacao implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Publicacao p1 = new Publicacao(null, Instant.parse("2022-01-23T19:53:07Z"), "Partiu viagem", "Vou pra sp",
				new AutorDTO(u1));
		Publicacao p2 = new Publicacao(null, Instant.parse("2022-01-23T19:53:07Z"), "Bom dia", "Acordei bem",
				new AutorDTO(u2));
		
		ComentarioDTO c1 = new ComentarioDTO("Boa viagem", Instant.parse("2022-01-23T19:53:07Z"), new AutorDTO(u1));

		p1.getComentario().addAll(Arrays.asList(c1));
